...
namespace PSMicrosoftSharepointOnline.Commands
{
    /// <summary>
    ...
    /// </summary>
    [Cmdlet(VerbsCommon.New, "PSMsTeamsBatchRequest", SupportsShouldProcess = true)]
    [OutputType(typeof(BatchRequestPayload))]
    public class NewPSMsSPOBatchRequest : PSCmdlet
    {
