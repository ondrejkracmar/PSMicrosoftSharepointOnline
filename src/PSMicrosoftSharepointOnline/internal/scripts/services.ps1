...
$endpointCfg = @{
	Name          = 'PSMicrosoftSharepointOnline.Endpoint'
...
$securityCfg = @{
	Name          = 'PSMicrosoftSharepointOnline.Security'
...
$graphCfg = @{
	Name          = 'PSMicrosoftSharepointOnline.Graph'
...
$graphBetaCfg = @{
	Name          = 'PSMicrosoftSharepointOnline.GraphBeta'
...
$azureCfg = @{
	Name          = 'PSMicrosoftSharepointOnline.Azure'
...
$azureKeyVaultCfg = @{
	Name          = 'PSMicrosoftSharepointOnline.AzureKeyVault'
...
$entraIDazTokenCfg = @{
	Name          = 'PSMicrosoftSharepointOnline.AzToken'
	ServiceUrl    = 'https://graph.microsoft.com/v1.0'
	Resource      = 'https://graph.microsoft.com'
	DefaultScopes = @()
	HelpUrl       = 'https://developer.microsoft.com/en-us/graph/quick-start'
