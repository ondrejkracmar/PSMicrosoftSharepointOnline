Function Test-PSMicrosoftSharepointOnlineBatchRequest {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        ...
        Test-PSMicrosoftSharepointOnlineBatchRequest -Requests $batchRequests
    ...
    .EXAMPLE
        ...
        $batchRequests | Test-PSMicrosoftSharepointOnlineBatchRequest -EnableException
    #>
        Param (
            [Parameter(
                Mandatory = $true,
